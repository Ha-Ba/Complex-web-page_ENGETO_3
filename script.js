...
// Mouseenter a mouseleave nad obrázky zasedaček
...
// Výběr divu s třídou .radio-buttons a uvnitř něj divu .inline-rb
...
const dateFilled = document.getElementById("date");
const timeFilled = document.getElementById("time");
...
// Inicializace stavu tlačítka submit
...
function validateForm() {
  ...
  // Aktivace tlačítka pouze pokud jsou splněny podmínky
